...
public class YelpDao {
	...
	public List<Business> getLocaliCitta(String citta) {
		String sql = "SELECT * "
				+ "FROM business "
				+ "WHERE city = ? order by business_name asc";
	...
	public List<Review> getVertici(String citta, Business business, Map<String, Review> idMap) {
		String sql = "SELECT r.review_id as id "
				+ "FROM reviews AS r, business AS b "
